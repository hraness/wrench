...
const linkedin = {
  ...
  "articles.draft.save": contract("linkedin", "articles.draft.save", "R2", "observed", "reviewed current-member-bound native Article title/content autosave with stable draft identity and exact unpublished readback"),
