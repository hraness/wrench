...
export const socialPlatformCatalog = {
  ...
  x: {
    ...
    operations: buildOperationMatrix({
      ...
      R2: ["likes.set", "relationships.follow.set", "content.save", "communities.membership.set"],
      R3: [
        "messaging.send",
        "replies.create",
        "posts.publish",
  ...
  substack: {
    ...
    operations: buildOperationMatrix({
      ...
      unsupported: ["media.publish", "threads.publish", "communities.membership.set"],
  ...
  threads: {
    ...
    operations: buildOperationMatrix({
      ...
      unsupported: ["media.publish", "articles.read", "articles.publish", "content.schedule"],
      notApplicable: [
        "comments.create",
        "reactions.set",
        "listings.read",
  ...
  bluesky: {
    ...
    operations: buildOperationMatrix({
      ...
      unsupported: ["media.publish", "articles.read", "articles.publish", "content.edit", "content.schedule"],
      notApplicable: [
        "comments.create",
        "reactions.set",
        "listings.read",
