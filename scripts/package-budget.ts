...
// contacts.list@3 Desktop loopback and archived 2.3.0 adapter baseline were
// byte-identical: 2,072,376 packed bytes, 12,230,695 unpacked bytes, and
// 466 files. Their SHA-256 was
// 6d9b427794aa2a74cd41badb9109f04c40f5be3fc20f4a9b7a4068c181b8d110. Prior CI
...
export const MAX_UNPACKED_BYTES = 12_234_939;
