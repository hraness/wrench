...
the complete readback and requires the ruleset IDs and
canonical UTC ruleset timestamp fingerprints to equal the privileged values
stored in `production-ref-writer-key`. Ruleset
